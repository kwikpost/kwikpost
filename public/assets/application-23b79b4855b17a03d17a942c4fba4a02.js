...
(function() {
  jQuery(function() {
    if ($('.pagination').length) {
      return $('#masonry-container').scroll(function() {
        var url;
        url = $('.pagination .next_page').attr('href');
        if (url && $('#masonry-container')[0].scrollHeight - $('#masonry-container').scrollTop() < 700) {
          $('.pagination').text('more products...');
