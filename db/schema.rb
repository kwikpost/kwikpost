...
ActiveRecord::Schema.define(version: 20150827211922) do
  ...
  add_index "user_reviews", ["reviewuser_id"], name: "index_user_reviews_on_reviewuser_id", using: :btree
